...
class AnnotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create annotation" do
    assert_difference("Annotation.count") do
      post annotations_url, params: { annotation: { latitude: @annotation.latitude, longitude: @annotation.longitude, text: @annotation.text, user_id: @annotation.user_id } }
    end
  ...
  test "should update annotation" do
    patch annotation_url(@annotation), params: { annotation: { latitude: @annotation.latitude, longitude: @annotation.longitude, text: @annotation.text, user_id: @annotation.user_id } }
